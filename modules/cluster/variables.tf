...
variable "kms_key_id" {
  description = "This KMS keys used by tasks running in this cluster to encrypt your storage.. Please be sure that the KMS Key has an appropriate key policy (https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/encrypt-log-data-kms.html)"
  type        = string
  default     = null
}
