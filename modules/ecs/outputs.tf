...
output "spot_autoscaling_group_id" {
  ...
  value       = module.autoscale_group.spot_autoscaling_group_id
}

output "spot_autoscaling_group_name" {
  description = "The spot autoscaling group name"
  value       = module.autoscale_group.spot_autoscaling_group_name
}

output "spot_autoscaling_group_arn" {
  description = "The ARN for this AutoScaling Group"
  value       = module.autoscale_group.spot_autoscaling_group_arn
}
